...
export default function Postcard({
  ...
  return (
    <Link
      href={href}
      className="hover:bg-tertiary bg-[#c5c5c5] dark:bg-[#0e0e0e] drop-shadow-2xl dark:drop-shadow-none hover:text-lighttext border-2 p-3 border-secondary rounded-xl overflow-hidden cursor-pointer transition-all text-left flex flex-col justify-between md:w-lg w-full max-w-84 xs:min-w-[24rem] md:max-w-xl hover:scale-105"
    >
