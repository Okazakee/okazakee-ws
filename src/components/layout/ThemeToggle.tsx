...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <span className={`text-xl lg:text-[1rem] lg:left-2 text-darktext dark:text-lighttext transition-all duration-[400ms] ease-in-out w-[8rem] absolute right-3 ${isDark ? 'opacity-100' : 'opacity-0'}`}>
        Dark Mode
      </span>
    </button>
  );
