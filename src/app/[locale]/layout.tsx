...
export default async function RootLayout({
  ...
  return (
    <html lang={ locale }>
      <Providers>
        <body id="about" className={`${whiteRabbit.variable} transition-colors duration-[400ms] ease-in-out font-whiterabt antialiased rounded-xl scroll-smooth relative min-h-screen`}>
